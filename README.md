...
* **Постоянный фокус:** Список текущих дел фиксируется в системной панели уведомлений. Вам не нужно открывать приложение, чтобы увидеть, что делать дальше.
...
Установите последнюю версию прилодения со [страницы релизов.](https://github.com/skrpld/Goalion/releases)
...
2.  **Настройте Firebase:**
    ...
    * Добавьте Android-приложение с вашим `applicationId`.
